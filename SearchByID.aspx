...
<body>
    ...
    <div>
    <center>
        Enter EmployeeID: <asp:TextBox ID="TextBox1" runat="server" Height="22px" Width="266px"></asp:TextBox>
        <asp:Button ID="Button1" runat="server" Height="33px" Text="Search" Width="92px" OnClick="Button1_Click" />
